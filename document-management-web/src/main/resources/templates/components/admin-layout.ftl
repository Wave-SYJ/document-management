            ...
            <#list currentUser.roles as role>
                <#if role.name == "ROLE_USER_ADMIN">
                    <div class="item">
                        ...
                        <div class="menu">
                                <a class="${(currentPage == "user")?then('item active', 'item')}" href="/admin/user"> 用户管理 </a>
                        </div>
                    </div>
                <#elseif role.name == "ROLE_DOCUMENT_ADMIN">
                    <div class="item">
                        ...
                        <div class="menu">
                            <a class="${(currentPage == "paper")?then('item active', 'item')}" href="/admin/paper"> 论文列表 </a>
                            <a class="${(currentPage == "journal")?then('item active', 'item')}" href="/admin/journal"> 期刊列表 </a>
                            <a class="${(currentPage == "entry")?then('item active', 'item')}" href="/admin/entry"> 词条列表 </a>
                        </div>
                    </div>
                <#elseif role.name == "ROLE_SYSTEM_ADMIN">
                    <div class="item">
                        ...
                        <div class="menu">
                            ...
                            <a class="${(currentPage == "announcement")?then('item active', 'item')}" href="/admin/announcement"> 通知管理 </a>
                        </div>
                    </div>
                </#if>
            </#list>
